...
// @desc    Search student by block
// @route   GET /api/v1/students/search/:blockId
// @access  Private

exports.searchByBlock = asyncHandler(async (req, res, next) => {
  ...
  Student.find({
    ...
    .then((student) => {
      res.status(201).json({
        success: true,
        message: "List of students by block",
        data: student,
      });
    })
    .catch((err) => {
